...
// Apple targets (macOS + iOS) use Metal; everything else uses CUDA. iOS is NOT macOS,
// so it must be grouped with macOS here or it would fall through to the CUDA branch.
